...
# Load head for cols
A_X  = pd.read_csv(projname + "_head.csv")
A_X.insert(0, 'Location', 0)
...
ids = B_X["Location"]
B_X.drop(labels="Location", axis=1, inplace=True)

# Load classifier
clf = joblib.load("/home/saraoonk/rq1ml-php/output/score/" + projname + '_model.pkl')
