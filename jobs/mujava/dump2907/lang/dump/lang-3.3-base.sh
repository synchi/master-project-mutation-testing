...
# Take 96h (4d, just in case), evaluate after initial runs.
...
java mujava.cli.genmutes $proj_name > ${output_filename}.txt
echo -e "\n" >> ${output_filename}.txt
java mujava.cli.runmutes $proj_name >> ${output_filename}.txt
