...
# Mutation testing
mvn org.pitest:pitest-maven:mutationCoverage -DexcludedTestClasses=org.apache.commons.codec.digest.MessageDigestAlgorithmsTest -Dmutators=AOR,INCREMENTS,UOI,AOD,ROR,CONDITIONALS_BOUNDARY,INVERT_NEGS,ABS,MATH,OBBN,CRCR > ${output_filename}.txt
