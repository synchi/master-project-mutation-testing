...
# Mutation testing
mvn org.pitest:pitest-maven:mutationCoverage -DexcludedTestClasses=org.apache.commons.math3.analysis.interpolation.MicrosphereProjectionInterpolatorTest -Dmutators=AOR,INCREMENTS,UOI,AOD,ROR,CONDITIONALS_BOUNDARY,INVERT_NEGS,ABS,MATH,OBBN,CRCR > ${output_filename}.txt
