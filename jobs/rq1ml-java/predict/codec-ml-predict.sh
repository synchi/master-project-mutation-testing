...
# Mutation testing
mvn org.pitest:pitest-maven:mutationCoverage  -DexcludedTestClasses=org.apache.commons.codec.digest.MessageDigestAlgorithmsTest -Dmutators=ALL > ${output_filename}.txt
