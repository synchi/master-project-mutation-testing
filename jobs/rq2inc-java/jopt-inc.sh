...
raw=$(git rev-list a3e2728^..HEAD --reverse | head -n 101)
commit_ids=($raw)
...
mvn org.pitest:pitest-maven:mutationCoverage -DwithHistory -Dmutators=ALL -Dcobertura.skip=true >> ${output_filename}.txt
