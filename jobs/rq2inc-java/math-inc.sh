...
raw=$(git rev-list 95a9d35^..HEAD --reverse | head -n 101)
commit_ids=($raw)
...
mvn org.pitest:pitest-maven:mutationCoverage -DexcludedTestClasses=org.apache.commons.math3.analysis.interpolation.MicrosphereProjectionInterpolatorTest -DwithHistory -Dmutators=ALL >> ${output_filename}.txt
