...
raw=$(git rev-list 6473fdc^..HEAD --reverse | head -n 101)
commit_ids=($raw)
...
mvn org.pitest:pitest-maven:mutationCoverage -DexcludedTestClasses=org.apache.james.mime4j.field.address.DefaultAddressBuilderTest
 -DwithHistory -Dmutators=ALL -Drat.skip=true >> ${output_filename}.txt
